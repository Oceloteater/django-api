...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='Vegan Korma')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Fancy beans on toast')
        r2 = create_recipe(user=self.user, title='Posh sausage roll')
        in1 = Ingredient.objects.create(user=self.user, name='Feta')
        in2 = Ingredient.objects.create(user=self.user, name='Sausage meat')
